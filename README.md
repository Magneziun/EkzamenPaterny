...
# Диаграмма классов
Взаимосвязи между всеми классами и интерфейсами показаны на диаграмме ниже. Вы можете загрузить собственное изображение (например, diagram.png) или использовать встроенный код Mermaid, который GitHub отобразит автоматически.
